...
@Component({
  selector: 'nx-angular-nest-starter-nx-welcome',
  template: `
    <!--
     * * * * * * * * * * * * * * * * * * * * * * * * * * * *
    ...
    <style>
      ...
      *,
      ...
      #hero {
        ...
        margin-top: 3.5rem;
        box-shadow: 0 0 0 5px #dd0031;
        transition: all 0.2s ease-in-out;
      }
      #hero:hover {
        box-shadow: 0 0 0 2px #e0234e;
      transition: all 0.2s ease-in-out;
      }
      #hero .text-container {
        color: #000000;
      ...
      #hero .text-container a {
        background: linear-gradient(to left, #dd0031, #e0234e);
        color: #ffffff;
      ...
      <div class="container">
        ...
        <div id="hero" class="rounded">
          <div class="text-container">
            ...
            <p>
              a message from server: <strong>{{ data }}</strong>
            </p>
            <a href="#commands"> What&apos;s next? </a>
          </div>
          <div class="logo-container">
            <img src="/assets/nx-angular-nest.png" alt="nx angular nest">
          </div>
        </div>
...
export class NxWelcomeComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.http.get('http://localhost:9000/api').subscribe((res: any) => {
